...
╚══════╝ ╚═════╝    ╚═╝   ╚═╝  ╚═╝╚═╝     ╚═╝                                           
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MOCH ASEP XC
     \033[1;91m➣ \033[1;92mFACEBOOK   :            MOCH ASEP XC
     \033[1;93m➣ \033[1;92mWHATSAPP   :            083861251898
     \033[1;96m➣ \033[1;92mGITHUB     :            LuthfiXayoranaXD
     \033[1;95m➣ \033[1;92mTOOLS      :            SEBUAH TOOLS UNTUK KLIK/MINING
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		print("%s [%sâ€¢%s] %sTOOL NAME : %sUID KLIK/MININH"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sVERSION   : %s1.1"%(G,R,G,Y,G))
		print("%s [%sâ€¢%s] %sYOUR KEY  : %s%s"%(G,R,G,Y,G,key))
		print("%s [%sâ€¢%s] %sSTATUS    : %s"%(G,R,G,Y,stat)) 
		print("\n\x1b[1;93m••••••••••••••••••••••••••••••••••••••••••••••••••••••••  ")
		print("\n%s [%s1%s]%s KLIK INDOMARET %s(170K)"%(G,R,G,Y,W))
		print("%s [%s2%s]%s KLIK ALFAMART %s(150K) V1"%(G,R,G,Y,G))
		print("%s [%s3%s]%s KLIK AFAGIT%s(200K) V2"%(G,R,G,Y,G))
		print("%s [%s4%s]%s MINING ALL GAME %s(250K FULL GAME) V3"%(G,R,G,Y,G))
		print("%s [%s5%s]%s LOGIN EMAIL : %s()"%(G,R,G,Y,G))
		print("%s [%s6%s]%s LOGIN PASSWORD %s() V1"%(G,R,G,Y,G))
		print(GET)
